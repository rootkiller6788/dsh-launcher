...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::content::mcp_health,
            commands::content::mcp_runtime,
            commands::content::mcp_config_get,
            commands::content::mcp_config_save,
            commands::content::mcp_config_remove,
            commands::content::mcp_import_detect,
            commands::content::mcp_import,
            ...
            commands::process::running_safe_tier,
